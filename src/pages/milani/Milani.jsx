...
const Milani = () => {
  ...
  useEffect(() => {
    const timeout = setTimeout(() => {
      fetch("http://makeup-api.herokuapp.com/api/v1/products.json?brand=milani")
      ...
      {loading ? (
        ...
        <div className="all_cards_wrapper">
          {product.map((pr) => (
              ...
              <Link to={`/milani/${pr.id}`}><img  className="card_images" width={200} src={pr.api_featured_image} alt="" /></Link>
              <br />
