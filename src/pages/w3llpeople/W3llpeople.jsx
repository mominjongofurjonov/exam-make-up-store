...
const W3llpeople = () => {
  ...
  useEffect(() => {
    const timeout = setTimeout(() => {
      fetch("http://makeup-api.herokuapp.com/api/v1/products.json?brand=w3llpeople")
      ...
      {loading ? (
        ...
        <div className="all_cards_wrapper">
          {product.map((pr) => (
              ...
              <Link to={`/w3llpeople/${pr.id}`}><img  className="card_images" width={200} src={pr.api_featured_image} alt="" /></Link>
              <br />
